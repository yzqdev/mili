...
!(function (e) {
  ...
  function o(e, a, n) {
    ...
    for (let l = 0, u = "", d = []; e.length || a.length; ) {
      let b = i();
  ...
  function d(e, r, n, i) {
    ...
    function l(e, t) {
      let r = v.cI ? t[0].toLowerCase() : t[0];
    ...
    function f() {
      let e = "string" == typeof N.sL;
      if (e && !x[N.sL]) return t(E);
      let r = e ? d(N.sL, E, !0, k[N.sL]) : b(E, N.sL.length ? N.sL : void 0);
      return (
        N.r > 0 && (M += r.r),
        e && (k[N.sL] = r.top),
  ...
  return (
    ...
    (e.C = function (t, r, a) {
      let n = e.inherit({ cN: "comment", b: t, e: r, c: [] }, a || {});
      return (
        n.c.push(e.PWM),
    ...
    e.registerLanguage("cs", function (e) {
      let t = {
          keyword:
            "abstract as base bool break byte case catch char checked const continue decimal default delegate do double enum event explicit extern finally fixed float for foreach goto if implicit in int interface internal is lock long nameof object operator out override params private protected public readonly ref sbyte sealed short sizeof stackalloc static string struct switch this try typeof uint ulong unchecked unsafe ushort using virtual void volatile while add alias ascending async await by descending dynamic equals from get global group into join let on orderby partial remove select set value let where yield",
    ...
    e.registerLanguage("javascript", function (e) {
      let t = "[A-Za-z$_][0-9A-Za-z$_]*",
        r = {
          keyword:
            "in of if for while finally let new function do return void else break catch instanceof with throw case default try this switch continue typeof delete let yield const export super debugger as async await static import from as",
    ...
    e.registerLanguage("php", function (e) {
      ...
      return {
        ...
        cI: !0,
        k: "and include_once list abstract global private echo interface as static endswitch array null if endwhile or const for endforeach self let while isset public protected exit foreach throw elseif include __FILE__ empty require_once do xor return parent clone use __CLASS__ __LINE__ else break print eval new catch __METHOD__ case exception default die require __FUNCTION__ enddeclare final try switch continue endfor endif declare unset true false trait goto instanceof insteadof __DIR__ __NAMESPACE__ yield finally",
        c: [
          e.HCM,
          e.C("//", "$", { c: [r] }),
