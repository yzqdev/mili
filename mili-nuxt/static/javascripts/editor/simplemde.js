...
!(function (e) {
  ...
  return (function t(e, n, r) {
    ...
    for (
      let o = "function" == typeof require && require, a = 0;
      a < r.length;
      a++
    )
      i(r[a]);
        ...
        function (e, t, n) {
          (function (t) {
            ...
            function h(e, t) {
              let n = 0 | m(t.length);
              e = o(e, n);
              for (let r = 0; n > r; r += 1) e[r] = 255 & t[r];
              return e;
            }
            function d(e, t, n, r) {
            ...
            function w(e, t, n, r) {
              ...
              r > o / 2 && (r = o / 2);
              for (let a = 0; r > a; a++) {
                let l = parseInt(t.substr(2 * a, 2), 16);
                if (isNaN(l)) return a;
                e[n + a] = l;
              }
              return a;
            ...
            function E(e, t, n) {
              let r = "";
              n = Math.min(e.length, n);
              for (let i = t; n > i; i++) r += String.fromCharCode(127 & e[i]);
              return r;
            }
            function O(e, t, n) {
              let r = "";
              n = Math.min(e.length, n);
              for (let i = t; n > i; i++) r += String.fromCharCode(e[i]);
              return r;
            }
            function I(e, t, n) {
              let r = e.length;
              (!t || 0 > t) && (t = 0), (!n || 0 > n || n > r) && (n = r);
              for (let i = "", o = t; n > o; o++) i += U(e[o]);
              return i;
            }
            function P(e, t, n) {
              for (let r = e.slice(t, n), i = "", o = 0; o < r.length; o += 2)
            ...
            function H(e, t, n, r) {
              0 > t && (t = 65535 + t + 1);
              for (let i = 0, o = Math.min(e.length - n, 2); o > i; i++)
                e[n + i] =
                  (t & (255 << (8 * (r ? i : 1 - i)))) >>>
                  (8 * (r ? i : 1 - i));
            }
            function W(e, t, n, r) {
              ...
              for (let i = 0, o = Math.min(e.length - n, 4); o > i; i++)
            ...
            function q(e, t) {
              t = t || 1 / 0;
              for (let n, r = e.length, i = null, o = [], a = 0; r > a; a++) {
            ...
            (n.Buffer = a),
              ...
              (a.compare = function (e, t) {
                ...
                if (e === t) return 0;
                for (
                  let n = e.length, r = t.length, i = 0, o = Math.min(n, r);
                  o > i;
                  ++i
                )
                  if (e[i] !== t[i]) {
              ...
              (a.prototype.swap16 = function () {
                ...
                for (let t = 0; e > t; t += 2) x(this, t, t + 1);
                return this;
              }),
            ...
            (a.prototype.slice = function (e, t) {
              ...
              (a.prototype.readIntBE = function (e, t, n) {
                (e = 0 | e), (t = 0 | t), n || R(e, t, this.length);
                for (let r = t, i = 1, o = this[e + --r]; r > 0 && (i *= 256); )
                  o += this[e + --r] * i;
        ...
        function (t, n, r) {
          !(function (i) {
            ...
            function n(e) {
              ...
              let n = e.state.fullScreenRestore;
      ...
      6: [
        function (t, n, r) {
          !(function (i) {
            ...
            function n(e) {
              t(e);
              let n = (e.state.placeholder = document.createElement("pre"));
              (n.style.cssText = "height: 0; overflow: visible"),
                (n.className = "CodeMirror-placeholder");
              let r = e.getOption("placeholder");
      ...
      9: [
        function (t, n, r) {
          !(function (i) {
            ...
            function i(e) {
              for (let t = e.state.markedSelection, n = 0; n < t.length; ++n)
                t[n].clear();
              t.length = 0;
            }
            function o(e) {
              i(e);
              for (let t = e.listSelections(), n = 0; n < t.length; n++)
                r(e, t[n].from(), t[n].to());
            }
            function a(e) {
              if (!e.somethingSelected()) return i(e);
              if (e.listSelections().length > 1) return o(e);
              let t = e.getCursor("start"),
                n = e.getCursor("end"),
          ...
          !(function (t) {
            ...
            function e(n, r) {
              ...
              "string" == typeof i &&
                ...
                (this.doc = i);
              let o = new e.inputStyles[r.inputStyle](this),
              ...
              xo &&
                ...
                (r.autofocus && !Ao) || s.hasFocus()
                  ...
                  : yn(this);
              for (let u in ta) ta.hasOwnProperty(u) && ta[u](this, r[u], na);
              k(this), r.finishInit && r.finishInit(this);
              for (let f = 0; f < aa.length; ++f) aa[f](this);
              kt(this),
                wo &&
                  r.lineWrapping &&
                  "optimizelegibility" ==
            ...
            function o(e) {
              ...
              return function (i) {
                ...
                let o = 0;
                if (i.widgets)
                  for (let a = 0; a < i.widgets.length; a++)
            ...
            function u(e) {
              let t = e.display.gutters.offsetWidth;
              e.display.sizer.style.marginLeft = t + "px";
            }
            function f(e) {
              if (0 == e.height) return 0;
              for (let t, n = e.text.length, r = e; (t = mr(r)); ) {
                let i = t.find(0, !0);
            ...
            function d(e) {
              let t = Pi(e.gutters, "CodeMirror-linenumbers");
              -1 == t && e.lineNumbers
            ...
            function w(e) {
              ...
              if (
                ...
                for (
                  let r = C(t) - t.scroller.scrollLeft + e.doc.scrollLeft,
                  ...
                  if (!n[a].hidden) {
                    ...
                    let l = n[a].alignable;
                    if (l)
                      for (let s = 0; s < l.length; s++) l[s].style.left = o;
                  }
            ...
            function O(e) {
              for (
                let t = e.display, n = t.lineDiv.offsetTop, r = 0;
                r < t.view.length;
                r++
              ) {
                let i,
                ...
                if (!o.hidden) {
                  if (xo && 8 > bo) {
                    let a = o.node.offsetTop + o.node.offsetHeight;
                    (i = a - n), (n = a);
                  } else {
                    let l = o.node.getBoundingClientRect();
                    i = l.bottom - l.top;
                  }
                  let s = o.line.height - i;
                  if (
                    (2 > i && (i = yt(t)),
                    (s > 0.001 || -0.001 > s) &&
                      (ei(o.line, i), I(o.line), o.rest))
                  )
                    for (let c = 0; c < o.rest.length; c++) I(o.rest[c]);
                }
              }
            }
            function I(e) {
            ...
            function R(e, t, n) {
              ...
              for (
                ...
                if (f.hidden);
                  ...
                  for (; l != f.node; ) l = r(l);
                  let h = o && null != t && c >= t && f.lineNumber;
                  f.changes &&
            ...
            function B(e, t) {
              let n = e.display.externalMeasured;
            ...
            function j(e, t, n) {
              ...
              for (let r, i = t.node.firstChild; i; i = r) {
                let r = i.nextSibling;
            ...
            function Z(e, t, n, r, i) {
              ...
              let a = e.state.pasteIncoming || "paste" == i,
                l = o.splitLines(t),
                s = null;
              if (a && r.ranges.length > 1)
                if (Fo && Fo.text.join("\n") == t) {
                  if (r.ranges.length % Fo.text.length == 0) {
                    s = [];
                    for (let c = 0; c < Fo.text.length; c++)
              ...
              for (let c = r.ranges.length - 1; c >= 0; c--) {
                let u = r.ranges[c],
                  f = u.from(),
                  h = u.to();
                u.empty() &&
            ...
            function J(e, t) {
              let n = e.clipboardData && e.clipboardData.getData("text/plain");
              return n
                ? (e.preventDefault(),
                  t.isReadOnly() ||
            ...
            function se(e, t, n) {
              function r(t, n, r) {
                for (let i = -1; i < (u ? u.length : 0); i++)
                  for (
                    let o = 0 > i ? c.map : u[i], a = 0;
                    a < o.length;
                    a += 3
                  ) {
                    let l = o[a + 2];
                    if (l == t || l == n) {
                      let s = ti(0 > i ? e.line : e.rest[i]),
                        f = o[a] + r;
                      return (
              ...
              if (t == i && ((o = !0), (t = i.childNodes[n]), (n = 0), !t)) {
                let a = e.rest ? Ii(e.rest) : e.line;
                return ae(Bo(ti(a), a.text.length), o);
              }
              let l = 3 == t.nodeType ? t : null,
                s = t;
              for (
                l ||
              ...
              if (f) return ae(f, o);
              for (
                let h = s.nextSibling, d = l ? l.nodeValue.length - n : 0;
                h;
                h = h.nextSibling
              ) {
              ...
              for (let p = s.previousSibling, d = n; p; p = p.previousSibling) {
            ...
            function ce(e, t, n, r, i) {
              ...
              function a(t) {
                if (1 == t.nodeType) {
                  ...
                  if (f) {
                    let h = e.findMarks(Bo(r, 0), Bo(i + 1, 0), o(+f));
                    return void (
                      h.length &&
                      (u = h[0].find()) &&
              ...
              for (
                let l = "", s = !1, c = e.doc.lineSeparator();
                a(t), t != n;
            ...
            function ye(e, t) {
              for (let n = [], r = 0; r < t.length; r++) n[r] = me(e, t[r]);
              return n;
            }
            function xe(e, t, n, r) {
            ...
            function we(e, t, n) {
              for (let r = [], i = 0; i < e.sel.ranges.length; i++)
                r[i] = xe(e, e.sel.ranges[i], t[i], null);
              let o = he(r, e.sel.primIndex);
              Te(e, o, n);
            }
            function ke(e, t, n, r) {
              let i = e.sel.ranges.slice(0);
            ...
            function ze(e, t, n) {
              for (
                ...
                let c = Fa(s.text, null, e.options.tabSize);
            ...
            function Ke(e, t, n) {
              ...
              if (!t.measure.heights || (r && t.measure.width != i)) {
                let o = (t.measure.heights = []);
                if (r) {
                  t.measure.width = i;
                  for (
                    let a = t.text.firstChild.getClientRects(), l = 0;
                    l < a.length - 1;
                    l++
                  ) {
                    let s = a[l],
            ...
            function nt(e, t, n) {
              for (let r, i, o, a, l = 0; l < e.length; l += 3) {
                let s = e[l],
                  c = e[l + 1];
                if (
                  (s > t
            ...
            function rt(e, t, n, r) {
              ...
              if (xo && 9 > bo && !l && (!i || (!i.left && !i.right))) {
                let h = a.parentNode.getClientRects()[0];
                i = h
                  ? {
                      left: h.left,
            ...
            function it(e, t) {
              if (
                ...
                return t;
              let n = screen.logicalXDPI / screen.deviceXDPI,
            ...
            function ut(e, t, n, r) {
              ...
              if (
                ...
                let l = e.display.lineSpace.getBoundingClientRect();
                a += l.top + ("window" == r ? 0 : ct());
                let s = l.left + ("window" == r ? 0 : st());
                (n.left += s), (n.right += s);
              }
            ...
            function ft(e, t, n) {
              ...
              if ("page" == n) (r -= st()), (i -= ct());
                ...
                let o = e.display.sizer.getBoundingClientRect();
                (r += o.left), (i += o.top);
              }
            ...
            function vt(e, t, n, r, i) {
              ...
              for (;;) {
                if (u ? d == h || d == fo(t, h, 1) : 1 >= d - h) {
                  for (
                    let y = p > r || g - r >= r - p ? h : d,
                      x = r - (y == h ? p : g);
                    zi(t.text.charAt(y));

                  )
                    ++y;
                  let b = mt(n, y, y == h ? m : v, -1 > x ? -1 : x > 1 ? 1 : 0);
                  return b;
                }
                let w = Math.ceil(f / 2),
                  k = h + w;
            ...
            function St(e) {
              for (let t = e.ops, n = 0; n < t.length; n++) Ct(t[n]);
              for (let n = 0; n < t.length; n++) Lt(t[n]);
              for (let n = 0; n < t.length; n++) Tt(t[n]);
              for (let n = 0; n < t.length; n++) Mt(t[n]);
              for (let n = 0; n < t.length; n++) Nt(t[n]);
            }
            function Ct(e) {
              let t = e.cm,
                n = t.display;
            ...
            function Rt(e, t, n) {
              for (let r, i = [], o = t; n > o; o = r) {
                let a = new Pt(e.doc, Zr(e.doc, o), o);
                (r = o + a.size), i.push(a);
              }
              return i;
            }
            ...
            function _t(e, t, n, r) {
              ...
              for (let l = 0, s = e.display.viewFrom; o > l; l++)
                s += a[l].size;
              if (s != t) {
                if (r > 0) {
            ...
            function Gt(e, t) {
              for (let n = wi(t); n != e.wrapper; n = n.parentNode)
                if (
                  !n ||
                  (1 == n.nodeType &&
            ...
            function Yt(e, t, n, r) {
              ...
              if (
                ...
                let u = Fa(s, s.length, e.options.tabSize) - s.length;
                c = Bo(
                  c.line,
                  Math.max(
                    0,
            ...
            function Xt(e, t, n, r, i) {
                ...
                if (0 != _o(g, t))
                  if (((g = t), "rect" == r)) {
                    ...
                    let x = u,
                      ...
                      w = t;
                    if ("single" != r) {
                      if ("double" == r) let k = e.findWordAt(t);
                      else
                        let k = new fe(Bo(t.line, 0), me(c, Bo(t.line + 1, 0)));
                      _o(k.anchor, b) > 0
                        ? ((w = k.head), (b = K(x.from(), k.anchor)))
                        : ((w = k.anchor), (b = V(x.to(), k.head)));
                    }
                    let i = h.ranges.slice(0);
              ...
              if (
                ...
                let p = e.findWordAt(n);
                u =
                  e.display.shift || c.extend ? xe(c, u, p.anchor, p.head) : p;
              } else if ("triple" == r) {
                let m = new fe(Bo(n.line, 0), me(c, Bo(n.line + 1, 0)));
                u =
            ...
            function Zt(e, t, n, r) {
              ...
              for (let s = 0; s < e.options.gutters.length; ++s) {
                let c = a.gutters.childNodes[s];
            ...
            function sn(e, t, n) {
              for (let r = 0; r < e.state.keyMaps.length; r++) {
                let i = ha(t, e.state.keyMaps[r], n, e);
                if (i) return i;
              }
              return (
            ...
            function mn(e) {
              ...
              if (
                ...
                if (!Co || (e.which && !(e.which < 10)) || !un(t, e)) {
                  let i = String.fromCharCode(null == r ? n : r);
            ...
            function En(e, t, n, r) {
              ...
              if (!(t.from.line > e.lastLine())) {
                if (t.from.line < e.first) {
                  let i = t.text.length - 1 - (e.first - t.from.line);
                  An(e, i),
                    (t = {
                      from: Bo(e.first, 0),
            ...
            function On(e, t, n) {
              ...
              e.options.lineWrapping ||
                ...
                _e(e, 400);
              let u = t.text.length - (l.line - a.line) - 1;
              t.full
                ? Dt(e)
            ...
            function Hn(e, t, n, r, i) {
              ...
              let l =
                ...
                c = {};
              i - n > s && (i = n + s);
              let u = e.doc.height + qe(o),
                f = a > n,
                h = i > u - a;
              if (l > n) c.scrollTop = f ? 0 : n;
              else if (i > l + s) {
                let d = Math.min(n, (h ? u : i) - s);
                d != l && (c.scrollTop = d);
              }
              let p =
            ...
            function Fn(e, t, n, r) {
              ...
              if (e.options.indentWithTabs)
                for (let d = Math.floor(c / a); d; --d) (h += a), (f += "	");
              if ((c > h && (f += Oi(c - h)), f != u))
                return (
              ...
              for (let d = 0; d < o.sel.ranges.length; d++) {
                let p = o.sel.ranges[d];
            ...
            function jn(e, t) {
              for (let n = e.doc.sel.ranges, r = [], i = 0; i < n.length; i++) {
                for (let o = t(n[i]); r.length && _o(o.from, Ii(r).to) <= 0; ) {
                  let a = r.pop();
            ...
            function Vn(e, t, n, r, i) {
              ...
              if (
                ...
                if ((l && (c.curOp.updateMaxLine = !0), o.collapsed))
                  ...
                  for (let u = t.line; u <= n.line; u++) Ht(c, u, "text");
            ...
            function Kn(e, t, n, r, i) {
              ...
              return (
                Kr(e, function (e) {
                  ...
                  for (let s = 0; s < e.linked.length; ++s)
            ...
            function Zn(e, t) {
              for (let n = 0; n < t.length; n++) {
                let r = t[n],
                  ...
                  a = e.clipPos(i.to);
                if (_o(o, a)) {
                  let l = Vn(e, o, a, r.primary, r.primary.type);
            ...
            function or(e, t) {
              ...
              let n = ve(e, t.from.line) && Zr(e, t.from.line).markedSpans,
              ...
              for (let i = 0; i < n.length; ++i) {
                ...
                if (o && a)
                  e: for (let l = 0; l < a.length; ++l) {
                    for (let s = a[l], c = 0; c < o.length; ++c)
            ...
            function dr(e, t) {
              let n = e.lines.length - t.lines.length;
              if (0 != n) return n;
              let r = e.find(),
                i = t.find(),
                o = _o(r.from, i.from) || fr(e) - fr(t);
              if (o) return -o;
              let a = _o(r.to, i.to) || hr(e) - hr(t);
            ...
            function yr(e) {
              for (let t; (t = mr(e)); ) e = t.find(-1, !0).line;
              return e;
            }
            function xr(e) {
              for (let t, n; (t = gr(e)); )
            ...
            function Sr(e, t, n) {
              if (null == n.to) {
                let r = n.marker.find(1, !0);
                return Sr(e, r.line, er(r.line.markedSpans, n.marker));
              }
              if (n.marker.inclusiveRight && n.to == t.text.length) return !0;
              for (let i, o = 0; o < t.markedSpans.length; ++o)
                if (
                  ((i = t.markedSpans[o]),
                  i.marker.collapsed &&
                    !i.marker.widgetNode &&
            ...
            function Ar(e, t) {
              if (e)
                for (;;) {
                  let n = e.match(/(?:^|\s+)line-(background-)?(\S+)/);
                  if (!n) break;
                  e = e.slice(0, n.index) + e.slice(n.index + n[0].length);
                  let r = n[1] ? "bgClass" : "textClass";
                  null == t[r]
                    ? (t[r] = n[2])
            ...
            function Rr(e, t, n, r) {
              ...
              for (let a = 0; a < e.state.overlays.length; ++a) {
                let l = e.state.overlays[a],
                  s = 1,
                  c = 0;
                Pr(
                  e,
            ...
            function Br(e, t) {
              ...
              for (let i = 0; i <= (t.rest ? t.rest.length : 0); i++) {
                ...
                (r.pos = 0),
                  ...
                  (r.map = []);
                let l = t != e.display.externalMeasured && ti(a);
                qr(a, r, Dr(e, a, l)),
                  a.styleClasses &&
            ...
            function Fr(e, t, n, r, i, o, a) {
              if (t) {
                let l = e.splitSpaces ? t.replace(/ {3,}/g, zr) : t,
                  ...
                  c = !1;
                if (s.test(t))
                  for (let u = document.createDocumentFragment(), f = 0; ; ) {
                    s.lastIndex = f;
                    let h = s.exec(t),
                      d = h ? h.index - f : t.length - f;
                    if (d) {
                      let p = document.createTextNode(l.slice(f, f + d));
                      xo && 9 > bo
                    ...
                    if (((f += d + 1), "	" == h[0])) {
                      ...
                      let p = e.cm.options.specialCharPlaceholder(h[0]);
                  ...
                  e.col += t.length;
                  let u = document.createTextNode(l);
            ...
            function qr(e, t, n) {
              ...
              if (r)
                for (
                  ...
                  if (v == p) {
                    ...
                    if (y)
                      for (let b = 0; b < y.length; b += 2)
                        y[b + 1] == v && (c += " " + y[b]);
                    if (!h || h.from == p)
                      for (let b = 0; b < x.length; ++b) Ur(t, 0, x[b]);
                    if (h && (h.from || 0) == p) {
                      if (
                        (Ur(
                          t,
                  ...
                  if (p >= d) break;
                  for (let S = Math.min(d, v); ; ) {
                    if (g) {
                      let C = p + g.length;
                      if (!h) {
                        let L = C > S ? g.slice(0, S - p) : g;
                        t.addToken(
                          t,
                          L,
                          a ? a + s : s,
            ...
            function ti(e) {
              ...
              for (
                let t = e.parent, n = Pi(t.lines, e), r = t.parent;
                r;
                t = r, r = r.parent
              )
            ...
            function ai(e, t) {
              let n = { from: $(t.from), to: Qo(t), text: Jr(e, t.from, t.to) };
              return (
            ...
            function mi(e, t) {
              let n = t["spans_" + e.id];
              if (!n) return null;
              for (let r = 0, i = []; r < t.text.length; ++r) i.push(pi(n[r]));
              return i;
            }
            function gi(e, t, n) {
            ...
            function yi(e, t, n, r) {
              for (let i = 0; i < e.length; ++i) {
                ...
                if (o.ranges) {
                  ...
                  for (let l = 0; l < o.ranges.length; l++)
            ...
            function Si(e, t, n) {
              let r = e._handlers && e._handlers[t];
            ...
            function Ci(e, t) {
              ...
              if (r.length) {
                ...
                for (let a = 0; a < r.length; ++a) i.push(n(r[a]));
              }
            }
            function Li() {
              let e = Ra;
            ...
            function Ri(e, t) {
              for (let n = [], r = 0; r < e.length; r++) n[r] = t(e[r], r);
              return n;
            }
            function Di() {}
            function Hi(e, t) {
            ...
            function Fi(e) {
              for (let t in e) if (e.hasOwnProperty(t) && e[t]) return !1;
              return !0;
            }
            function zi(e) {
            ...
            function ji(e, t, n, r) {
              ...
              if (
                ...
                for (let o = 0; o < t.length; ++o) i.appendChild(t[o]);
              return i;
            }
            function Ui(e) {
            ...
            function Vi(e) {
              if (document.body.getElementsByClassName)
                for (
                  let t = document.body.getElementsByClassName("CodeMirror"),
                    n = 0;
                  n < t.length;
                  n++
                ) {
                  let r = t[n].CodeMirror;
                  r && e(r);
                }
            }
            function Ki() {
            ...
            Po && (Po = Number(Po[1])),
              Po && Po >= 15 && ((Co = !1), (wo = !0));
            let Ro = Eo && (ko || (Co && (null == Po || 12.11 > Po))),
              Do = go || (xo && bo >= 9),
              Ho = !1,
              Wo = !1;
            (m.prototype = Wi(
              {
                update: function (e) {
                  ...
                  if (t) {
                    ...
                    let o = e.viewWidth - e.barLeft - (n ? r : 0);
            ...
            (ne.prototype = Wi(
              {
                ...
                poll: function () {
                  ...
                  for (
                    let o = 0, a = Math.min(n.length, r.length);
              ...
              (ie.prototype = Wi(
                {
                  ...
                  showPrimarySelection: function () {
                    ...
                    if (
                      ...
                      if (i || o) {
                        ...
                        try {
                          let u = qa(i.node, i.offset, o.offset, o.node);
                        } catch (f) {}
                        u &&
                  ...
                  pollSelection: function () {
                    if (
                      ...
                      let e = window.getSelection(),
                        t = this.cm;
                      this.rememberSelection();
                      let n = le(t, e.anchorNode, e.anchorOffset),
                  ...
                  pollContent: function () {
                    ...
                    if (r.line == t.viewFrom || 0 == (o = Bt(e, r.line)))
                      let a = ti(t.view[0].line),
                        l = t.view[0].node;
                    else
                      let a = ti(t.view[o].line),
                    ...
                    if (s == t.view.length - 1)
                      ...
                      let c = ti(t.view[s + 1].line) - 1,
                        u = t.view[s + 1].node.previousSibling;
                    for (
                      let f = e.doc.splitLines(ce(e, l, u, a, c)),
                        h = Jr(
                          e.doc,
                          Bo(a, 0),
            ...
            (e.prototype = {
              ...
              removeKeyMap: function (e) {
                for (let t = this.state.keyMaps, n = 0; n < t.length; ++n)
                  if (t[n] == e || t[n].name == e) return t.splice(n, 1), !0;
              },
              addOverlay: Ot(function (t, n) {
                let r = t.token ? t : e.getMode(this.options, t);
                if (r.startState)
              ...
              indentSelection: Ot(function (e) {
                for (
                  let t = this.doc.sel.ranges, n = -1, r = 0;
                  r < t.length;
                  r++
                ) {
                  let i = t[r];
          ...
          function B(e) {
            ...
            if (
              ...
              for (var n = document.styleSheets, r = 0; r < n.length; r++)
                n[r].href &&
                  n[r].href.indexOf("/styles/font_awesome/") > -1 &&
                  (t = !1);
            if (t) {
              var i = document.createElement("link");
              (i.rel = "stylesheet"),
                (i.href = "/styles/font_awesome.css"),
