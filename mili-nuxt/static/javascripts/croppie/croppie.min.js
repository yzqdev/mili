!(function (e, t) {
  ...
  function t(e) {
    if (e in q) return e;
    for (let t = e[0].toUpperCase() + e.slice(1), n = T.length; n--; )
      if ((e = T[n] + t) in q) return e;
  }
  function n(e, t) {
    e = e || {};
    for (let i in t)
  ...
  function d() {
    let e,
      ...
      a,
      s = this,
      u = s.options.viewport.type ? "cr-vp-" + s.options.viewport.type : null;
    (s.options.useCanvas = s.options.enableOrientation || m.call(s)),
      (s.data = {}),
      (s.elements = {}),
      (e = s.elements.boundary = document.createElement("div")),
      (t = s.elements.viewport = document.createElement("div")),
      (s.elements.img = document.createElement("img")),
      (n = s.elements.overlay = document.createElement("div")),
      s.options.useCanvas
        ? ((s.elements.canvas = document.createElement("canvas")),
          (s.elements.preview = s.elements.canvas))
        : (s.elements.preview = s.elements.img),
      r(e, "cr-boundary"),
      e.setAttribute("aria-dropeffect", "none"),
      (i = s.options.boundary.width),
      (a = s.options.boundary.height),
      o(e, {
        width: i + (isNaN(i) ? "" : "px"),
        height: a + (isNaN(a) ? "" : "px"),
      }),
      ...
      r(s.elements.preview, "cr-image"),
      l(s.elements.preview, { alt: "preview", "aria-grabbed": "false" }),
      r(n, "cr-overlay"),
      s.element.appendChild(e),
      e.appendChild(s.elements.preview),
      e.appendChild(t),
      e.appendChild(n),
      r(s.element, "croppie-container"),
      s.options.customClass && r(s.element, s.options.customClass),
      x.call(this),
      s.options.enableZoom && g.call(s),
      s.options.enableResize && f.call(s);
  }
  function m() {
  ...
  function f() {
    function e(e) {
      if ((void 0 === e.button || 0 === e.button) && (e.preventDefault(), !m)) {
        let o = p.elements.overlay.getBoundingClientRect();
        if (
          ((m = !0),
          (a = e.pageX),
          (l = e.pageY),
          (i =
            -1 !== e.currentTarget.className.indexOf("vertical") ? "v" : "h"),
          (s = o.width),
          (u = o.height),
          e.touches)
        ) {
    ...
    function t(e) {
      ...
      "v" === i && m >= f && m <= u
        ? (o(d, { height: m + "px" }),
          ...
          o(p.elements.boundary, { height: p.options.boundary.height + "px" }),
          (p.options.viewport.height += h),
          o(p.elements.viewport, { height: p.options.viewport.height + "px" }))
        : "h" === i &&
          v >= f &&
          v <= s &&
          (o(d, { width: v + "px" }),
          (p.options.boundary.width += c),
          o(p.elements.boundary, { width: p.options.boundary.width + "px" }),
          (p.options.viewport.width += c),
          o(p.elements.viewport, { width: p.options.viewport.width + "px" })),
        C.call(p),
        B.call(p),
        b.call(p),
        E.call(p),
    ...
    r(d, "cr-resizer"),
      ...
      this.options.resizeControls.height &&
        (r((c = document.createElement("div")), "cr-resizer-vertical"),
        d.appendChild(c)),
      this.options.resizeControls.width &&
        (r((h = document.createElement("div")), "cr-resizer-horisontal"),
        d.appendChild(h)),
  ...
  function w(e) {
    function t() {
      let e = {};
      (e[P] = i.toString()), (e[N] = a.toString()), o(n.elements.preview, e);
    }
    let n = this,
    ...
    if (
      ...
      let l = y.call(n, r),
        s = l.translate,
        u = l.origin;
      i.x >= s.maxX && ((a.x = u.minX), (i.x = s.maxX)),
        i.x <= s.minX && ((a.x = u.maxX), (i.x = s.minX)),
        i.y >= s.maxY && ((a.y = u.minY), (i.y = s.maxY)),
        i.y <= s.minY && ((a.y = u.maxY), (i.y = s.minY));
    }
    t(), Q.call(n), E.call(n);
  }
  function y(e) {
  ...
  function b() {
    let e = this,
      ...
      r = K.parse(e.elements.preview.style[P]),
  ...
  function x() {
    function e(e, t) {
      let n = d.elements.preview.getBoundingClientRect(),
        i = p.y + t,
        o = p.x + e;
    ...
    function t(e) {
      d.elements.preview.setAttribute("aria-grabbed", e),
        d.elements.boundary.setAttribute(
          "aria-dropeffect",
          e ? "move" : "none"
        );
    }
    ...
    function r(e) {
      if ((void 0 === e.button || 0 === e.button) && (e.preventDefault(), !m)) {
        if (((m = !0), (s = e.pageX), (u = e.pageY), e.touches)) {
          let n = e.touches[0];
          (s = n.pageX), (u = n.pageY);
        }
        t(m),
    ...
    function a(t) {
      ...
      if ("touchmove" == t.type && t.touches.length > 1) {
        ...
        let y = w / c;
        return v.call(d, y), void i(d.elements.zoomer);
      }
      e(l, h),
        (m[P] = p.toString()),
        o(d.elements.preview, m),
        C.call(d),
        (u = r),
        (s = n);
    }
    ...
    let s,
      ...
      d = this,
      m = !1;
    d.elements.overlay.addEventListener("mousedown", r),
      d.elements.viewport.addEventListener("keydown", function (e) {
        let t = 37,
          i = 38,
          o = 39,
          r = 40;
      ...
      d.elements.overlay.addEventListener("touchstart", r);
  }
  function C() {
    let e = this,
  ...
  function E() {
    let e = this,
      t = e.get();
    if (_.call(e))
      if ((e.options.update.call(e, t), e.$ && "undefined" == typeof Prototype))
        e.$(e.element).trigger("update", t);
      else {
        let n;
        window.CustomEvent
          ? (n = new CustomEvent("update", { detail: t }))
  ...
  function L() {
    ...
    _.call(e) &&
      ...
      e.options.enableZoom ? B.call(e, !0) : (e._currentZoom = 1),
  ...
  function R(e) {
    ...
    let t = this,
      ...
      a = { left: i.left - r.left, top: i.top - r.top },
      l = i.width / n,
      s = e[1],
      u = e[0],
      c = -1 * e[1] + a.top,
  ...
  function M(e) {
    ...
    o.clearRect(0, 0, n.width, n.height),
      (n.width = i.width),
      (n.height = i.height),
      r && !e ? p(n, i, s(h(i) || 0, 10)) : e && p(n, i, e);
  }
  function Z(e) {
    let t = this,
      n = e.points,
    ...
    return (
      e.outputWidth &&
        e.outputHeight &&
        ((g = e.outputWidth), (w = e.outputHeight), (y = g / d)),
      (h.width = g),
      (h.height = w),
      e.backgroundColor &&
        ((p.fillStyle = e.backgroundColor), p.fillRect(0, 0, d, m)),
      t.options.enforceBoundary ||
        (i < 0 && ((f = Math.abs(i)), (i = 0)),
        o < 0 && ((v = Math.abs(o)), (o = 0)),
        r > t._originalImageWidth && (d = l = t._originalImageWidth - i),
      ...
      p.drawImage(
        ...
        i,
        o,
        Math.min(l, t._originalImageWidth),
  ...
  function z(e) {
    ...
    return (
      r(n, "croppie-result"),
      n.appendChild(i),
      o(i, { left: -1 * t[0] + "px", top: -1 * t[1] + "px" }),
      (i.src = e.url),
      o(n, { width: a + "px", height: l + "px" }),
      n
    );
  }
  function Y(e) {
  ...
  function X(e, t) {
    ...
    if ("string" == typeof e) (n = e), (e = {});
      ...
      if (void 0 === e && i.data.url) return L.call(i), E.call(i), null;
      (n = e.url),
        (o = e.points || []),
      ...
      u(n, i.elements.img, a).then(function (n) {
        if (o.length)
          ...
          let r,
            a,
            l = c(n),
            s = i.elements.viewport.getBoundingClientRect(),
            u = s.width / s.height;
          l.width / l.height > u
            ? (r = (a = l.height) * u)
            : (a = (r = l.width) / u);
  ...
  function H() {
    let e = this,
      ...
      u = e._currentZoom;
    (u === 1 / 0 || isNaN(u)) && (u = 1);
    let c = e.options.enforceBoundary ? 0 : Number.NEGATIVE_INFINITY;
    return (
      (i = Math.max(c, i / u)),
      (o = Math.max(c, o / u)),
      (l = Math.max(c, l / u)),
      (s = Math.max(c, s / u)),
      { points: [F(i), F(o), F(l), F(s)], zoom: u }
    );
  }
  function k(e) {
    let t = this,
    ...
    return (
      "viewport" === a
        ? ((i.outputWidth = h.width), (i.outputHeight = h.height))
        : "object" == typeof a &&
          (a.width && a.height
            ? ((i.outputWidth = a.width), (i.outputHeight = a.height))
            : a.width
            ? ((i.outputWidth = a.width), (i.outputHeight = a.width / p))
            : a.height &&
              ((i.outputWidth = a.height * p), (i.outputHeight = a.height))),
      J.indexOf(l) > -1 && ((i.format = "image/" + l), (i.quality = s)),
      (i.circle = c),
      (i.url = t.data.url),
      (i.backgroundColor = u),
  ...
  function O(e, t) {
    if (
      ...
      let i = this.element;
      r(i, "cr-original-image"), l(i, { "aria-hidden": "true", alt: "" });
    ...
    if ((d.call(this), this.options.url)) {
      let a = { url: this.options.url, points: this.options.points };
      delete this.options.url, delete this.options.points, X.call(this, a);
    }
  }
    ...
    (function (e) {
      ...
      function i(e) {
        ...
        return null === this._state
          ...
          : void c(function () {
              let n = t._state ? e.onFulfilled : e.onRejected;
              if (null !== n) {
                let i;
                try {
                  i = n(t._value);
      ...
      function a() {
        for (let e = 0, t = this._deferreds.length; t > e; e++)
      ...
      (n.prototype.catch = function (e) {
        ...
        (n.all = function () {
          ...
          return new n(function (t, n) {
            ...
            for (let o = e.length, r = 0; r < e.length; r++) i(r, e[r]);
          });
        }),
        ...
        (n.race = function (e) {
          return new n(function (t, n) {
            for (let i = 0, o = e.length; o > i; i++) e[i].then(t, n);
          });
        }),
    ...
    HTMLCanvasElement.prototype.toBlob ||
      Object.defineProperty(HTMLCanvasElement.prototype, "toBlob", {
        value: function (e, t, n) {
          for (
            let i = atob(this.toDataURL(t, n).split(",")[1]),
              o = i.length,
              r = new Uint8Array(o),
              a = 0;
            a < o;
  ...
  (P = t("transform")), (N = t("transformOrigin")), (D = t("userSelect"));
  let U = { translate3d: { suffix: ", 0px" }, translate: { suffix: "" } },
    K = function (e, t, n) {
      (this.x = parseFloat(e)),
        (this.y = parseFloat(t)),
  ...
  (K.parse = function (e) {
    ...
    (K.fromMatrix = function (e) {
      ...
      return (
        ...
        new K(s(t[4]), s(t[5]), parseFloat(t[0]))
      );
    }),
    ...
    (K.prototype.toString = function () {
      let e = U[O.globals.translate].suffix || "";
      return (
        O.globals.translate +
        "(" +
        this.x +
    ...
    V.fn.croppie = function (e) {
      if ("string" === typeof e) {
        ...
        return "get" === e
          ...
          ? n.bind.apply(n, t)
          : this.each(function () {
              let n = V(this).data("croppie");
              if (n) {
                let i = n[e];
                if (!V.isFunction(i))
                  throw "Croppie " + e + " method not found";
                i.apply(n, t), "destroy" === e && V(this).removeData("croppie");
              }
            });
      }
  ...
  (O.defaults = {
    ...
    (O.globals = { translate: "translate3d" }),
    n(O.prototype, {
      bind: function (e, t) {
      ...
      setZoom: function (e) {
        v.call(this, e), i(this.elements.zoomer);
      },
      rotate: function (e) {
        A.call(this, e);
      },
