...
import (
	...
	"mili/config"
	"mili/controller/article"
	"mili/controller/baidu"
	"mili/controller/book"
	"mili/controller/category"
	"mili/controller/collect"
	"mili/controller/comment"
	"mili/controller/common"
	"mili/controller/crawler"
	"mili/controller/message"
	"mili/controller/user"
	"mili/controller/vote"
	"mili/middleware"
)
